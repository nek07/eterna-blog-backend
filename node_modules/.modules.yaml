...
hoistedDependencies:
  ...
  cookiejar@2.1.4:
    cookiejar: private
  create-jest@29.7.0(@types/node@22.15.0):
    create-jest: private
  cross-spawn@7.0.6:
    cross-spawn: private
  cssstyle@4.3.1:
  ...
  jest-circus@29.7.0:
    jest-circus: private
  jest-cli@29.7.0(@types/node@22.15.0):
    jest-cli: private
  jest-config@29.7.0(@types/node@22.15.0):
    jest-config: private
  jest-diff@29.7.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Thu, 24 Apr 2025 20:47:05 GMT
publicHoistPattern: []
registries:
...
skipped:
  ...
  - '@esbuild/win32-ia32@0.25.3'
  - fsevents@2.3.3
storeDir: C:\Users\abyla\AppData\Local\pnpm\store\v10
virtualStoreDir: C:\Users\abyla\OneDrive\Рабочий стол\eterna-blog-backend\node_modules\.pnpm
